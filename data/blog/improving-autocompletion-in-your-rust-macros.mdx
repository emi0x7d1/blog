...
summary: "How to make your Rust macros more Rust Analyzer-friendly"
date: 2023-10-01
tags: ["rust", "metaprogramming", "dx"]
---
...
![Rust Analyzer suggesting Foo's fields](/static/images/ra-completing-foo-fields.png)

RA uses the same context for other actions such as `Rename`.

<video src="/static/videos/renaming-foo-field.mp4" autoPlay muted loop style={{ width: "100%" }}></video>
...
![Rust Analyzer suggesting html elements](/static/images/ra-completing-html-elements.png)
...
![RA not suggesting `Box` props](/static/images/ra-not-suggesting-box-props.png)
...
![Rust Analyzer suggesting `Box` props](/static/images/ra-suggesting-box-props.png)
